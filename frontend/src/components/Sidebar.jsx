...
import {
    ...
    FileText, Pill, MessageSquare, Bell, Settings,
    Hospital, ClipboardList, ShieldCheck, Activity
} from 'lucide-react';
    ...
    return (
        <aside className='w-60 min-h-screen bg-white border-r border-gray-200 flex flex-col'>
            ...
            <div className='px-6 py-5 border-b border-gray-100'>
                <span className='text-lg font-bold text-teal-600'>Health Assistant</span>
            </div>
