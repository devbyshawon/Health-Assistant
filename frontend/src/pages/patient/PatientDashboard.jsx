...
import { Calendar, Pill, Activity, Stethoscope, MessageSquare, CalendarPlus, UserCog } from 'lucide-react';
    ...
    return (
        <DashboardLayout>
            <div className='max-w-6xl mx-auto'>
                <div className='mb-6'>
                    <h1 className='text-2xl font-bold text-teal-900'>Welcome back, {user?.name}</h1>
                </div>
                    ...
                    >
                        <div className='flex items-center gap-3'>
                            ...
                            <p className='text-sm font-medium'>
                                Your profile is {completion}% complete — add more details
                            </p>
                        </div>
                ...
                {!loading && summary?.totalLogs > 0 && (
                    <div className='bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-8'>
                        <h3 className='font-semibold text-teal-900 mb-4'>Latest Health Snapshot</h3>
                        ...
                        <p className='text-xs text-gray-400 mt-3'>
                            Based on {summary.totalLogs} logged {summary.totalLogs === 1 ? 'entry' : 'entries'}
                        </p>
                    </div>
                )}
